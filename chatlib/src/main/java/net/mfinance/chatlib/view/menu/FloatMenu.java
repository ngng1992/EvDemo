package net.mfinance.chatlib.view.menu;
...
public class FloatMenu extends PopupWindow{
	...
	public FloatMenu(AppCompatActivity activity){
	...
	public FloatMenu(Context context, View view) {
		...
		DEFAULT_MENU_WIDTH = Display.dip2px(context, 120);
	...
	private void generateLayout(int itemWidth) {
		...
		for(int i = 0; i < menuItemList.size(); i ++){
			...
			textView.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.selector_pop_item));
