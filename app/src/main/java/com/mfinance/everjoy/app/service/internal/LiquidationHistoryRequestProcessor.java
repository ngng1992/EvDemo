...
public class LiquidationHistoryRequestProcessor implements MessageProcessor{
	...
	public boolean processMessage(Message msg, FxMobileTraderService service) {
        ...
        try {			
			MessageObj executedOrderHistoryRequestMsg = MessageObj.getMessageObj(IDDictionary.SERVER_IO_SERVICE_TYPE, IDDictionary.SERVER_IO_REQUEST_TRADES_LIQUIDATION);			
