...
package com.mfinance.everjoy.app.widget.dragndroplist;
...
public class DragNDropListView extends ListView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if (action == MotionEvent.ACTION_DOWN && x < this.getWidth() / 4) {
			if(draggable)
				mDragMode = true;
			//System.out.println("Drag a:" +action + "w: "+ (this.getWidth()/ 4)+" x:"+x+" y:"+y);
		}else{
			//System.out.println("Non Drag a:" +action + "w: "+ (this.getWidth()/ 4)+" x:"+x+" y:"+y);
		}
