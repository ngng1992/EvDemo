...
public class BankInfoRequestProcessor implements MessageProcessor{
	...
	public boolean processMessage(Message msg, FxMobileTraderService service) {
        ...
        try {			
			MessageObj executedOrderHistoryRequestMsg = MessageObj.getMessageObj(IDDictionary.SERVER_IO_SERVICE_TYPE, IDDictionary.SERVER_IO_REQUEST_BANK_INFORMATION);
			...
			//Log.i(TAG, "[Sent BankInfoRequestProcessor.]");
