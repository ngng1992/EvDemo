package com.mfinance.everjoy.app.widget.quickaction;
...
public class CustomPopupWindow {
	 ...
	 *            the view that the QuickAction will be displaying 'from'
	 */
	public CustomPopupWindow(View anchor, Supplier<PopupWindow> popupWindowSupplier) {
		this.anchor = anchor;
		this.window = popupWindowSupplier.get();
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		...
		Rect anchorRect =
				new Rect(location[0], location[1], location[0] + anchor.getWidth()+1000, location[1]
					+ anchor.getHeight()+1000);
