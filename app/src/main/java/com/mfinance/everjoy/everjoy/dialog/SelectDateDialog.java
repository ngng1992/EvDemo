...
public class SelectDateDialog extends BaseBottomDialog {
    ...
    public SelectDateDialog(@NonNull Context context, Calendar selectDate) {
        super(context);
    ...
    protected void initView() {
        ...
        endDate.set(year + 3, month, date);

        datePickerView.setStartDate(startDate);
        datePickerView.setSelectedDate(selectDate == null ? Calendar.getInstance() : selectDate);
